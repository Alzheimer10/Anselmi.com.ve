<nav class="side row h-100">
    ...
    <div class="side__bottom">
        ...
        <a social="facebook" href="https://www.facebook.com/carlos.anselmi1" target="_blank"><i class="fab fa-facebook-f"></i></a>
        <a social="twitter" href="https://twitter.com/AnselmiCarlos" target="_blank"><i class="fab fa-twitter"></i></a>
        <a social="email" href="mailto:carlos@anselmi.com.ve"><i class="far fa-envelope"></i></a>
    </div>
</nav>